...
export default function HeroAdmin() {
  ...
  const [formData, setFormData] = useState({
    heroHeadline: 'Data is Dynamic.',
    heroSubtext: 'Wahana Data Utama architects intelligence. We bridge the gap between complex raw data and high-velocity business growth.',
    backgroundImageUrl: 'https://sis.wahanadata.co.id/img/wdu-building.jpg',
  });
  ...
  return (
    <div className="max-w-2xl">
      <div className="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm">
        <h2 className="text-lg font-extrabold text-accent-dark mb-6">Hero Section Settings</h2>
