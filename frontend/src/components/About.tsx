      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        >
          ...
          <div className="relative">
            ...
            >
              <img
                src="https://wahanadata.co.id/wp-content/uploads/2025/02/Pak-Yudi-homepage-2.png"
        ...
        >
          ...
          <motion.div variants={itemVariants} className="space-y-6 text-lg text-slate-600 font-light leading-relaxed">
            <p>
              Wahana Data Utama didirikan pada 2006 merupakan perusahaan riset dan survei yang berfokus pada bidang sosial-politik, ekonomi, pemasaran, pertanian, dan lainnya.
            </p>
            <p>
              Dengan visi menjadi penyedia data riset global, WDU didukung oleh tim profesional berpengalaman lebih dari 10 tahun. Berkantor di Bogor, kami telah memperoleh kepercayaan dari berbagai instansi pemerintah dan swasta untuk menangani berbagai proyek konsultasi, mulai dari riset hingga event organizing.
            </p>
          </motion.div>
